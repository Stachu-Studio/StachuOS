...
#change password says current user:password
#
...
def show_OS_info():
    ...
    info_OS_ver = tk.Label(os_info, text="Stachu OS 2", bg="#757171", fg="white", font="Helvetica, 30")
...
def open_shell():
    ...
    shell_ver_show = tk.Label(shell, text="stachu OS shell version 2/1", bg="black", fg="white", font="Helvetica, 20")
...
def change_login_password():
    ...
    current_account_password = tk.Label(account_password, text=f"Current account name: {login_password}",bg="#757171", font="Helvetica, 15")
...
def change_login_icon():
    ...
    account_blue_icon = PhotoImage(file="C:/Users/stach/Desktop/Stachu OS/icons/account_icons/account_icon_dark_blue.png")
...
def change_wallpaper():
    ...
    wallpaper_btn = tk.Button(account_wallpaper, text="restart desktop", command=apply_wallpaper, font="Helvetica, 25")
...
def start_menu():
    ...
    if default_icon == True:
        account_icon = PhotoImage(file="C:/Users/stach/Desktop/Stachu OS/icons/account_icon.png")
        ...
        account_icon = PhotoImage(file="C:/Users/stach/Desktop/Stachu OS/icons/account_icons/account_icon_red.png")
        account_btn = tk.Button(start, image=account_icon, bg="#757171", command=account_settings_show)
        account_btn.image = account_icon
        account_btn.place(x=1, y=1)

    elif blue_icon == True:
        account_icon = PhotoImage(file="C:/Users/stach/Desktop/Stachu OS/icons/account_icons/account_icon_dark_blue.png")
        account_btn = tk.Button(start, image=account_icon, bg="#757171", command=account_settings_show)
        account_btn.image = account_icon
        account_btn.place(x=1, y=1)

    elif green_icon == True:
        account_icon = PhotoImage(file="C:/Users/stach/Desktop/Stachu OS/icons/account_icons/account_icon_green.png")
        account_btn = tk.Button(start, image=account_icon, bg="#757171", command=account_settings_show)
        account_btn.image = account_icon
        account_btn.place(x=1, y=1)

    elif yellow_icon == True:
        account_icon = PhotoImage(file="C:/Users/stach/Desktop/Stachu OS/icons/account_icons/account_icon_yellow.png")
        account_btn = tk.Button(start, image=account_icon, bg="#757171", command=account_settings_show)
        account_btn.image = account_icon
        account_btn.place(x=1, y=1)


    power_icon = PhotoImage(file="C:/Users/stach/Desktop/Stachu OS/icons/power_icon.png")
    ...
    info_icon = PhotoImage(file="C:/Users/stach/Desktop/Stachu OS/icons/info_icon.png")
    ...
    shell_icon = PhotoImage(file="C:/Users/stach/Desktop/Stachu OS/icons/code_icon.png")
    ...
    messages_icon = PhotoImage(file="C:/Users/stach/Desktop/Stachu OS/icons/messages_icon.png")
...
def desktop():
    ...
    start_icon = PhotoImage(file="C:/Users/stach/Desktop/Stachu OS/icons/start_icon.png")
